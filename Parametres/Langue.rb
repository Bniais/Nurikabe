...
class Langue
    ...
    def initialize()
      ...
      @dico["EXPENSION_MUR"] = "There is a wall that has only one way to expand to prevent it from being isolated"
      @dico["CONTINUITE_MUR"] = "There is a cell that has to be expanded to prevent two walls from being separated"
      @dico["EXPENSION_ILE"] = "There is a island that has onlu one way to expand in order to get developed"
