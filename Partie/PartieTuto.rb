class PartieTuto < Partie
  ...
  def initialize()
    ...
    @coupAutoriser = [
      [
        [999 , 999 , 999 , 999, 999, 999],[ 999 , 999 , 1 , 0, 999, 999],[999 , 999 , 999 , 999, 999, 999],[999 , 999 , 999 , 999, 999, 999], [999 , 999 , 999 , 999, 999, 999], [999 , 999 , 999 , 999, 999, 999]
      ],
      [
        [999 , 999 , 999 , 999, 999, 999],[ 999 , 999 , 1 , 0, 999, 999],[999 , 999 , 999 , 999, 999, 999],[999 , 999 , 999 , 999, 999, 999], [999 , 999 , 999 , 999, 999, 999], [999 , 999 , 999 , 999, 999, 999]
      ],
    ...
    @messageEtape = [
      ...
      "Tous les murs doivent former un chemin continu. Ce qui signifie que tous les murs doivent être connectés entre eux. Ici, le mur adjacent à l'ile d'incide 6 à un seul carré, la seule façon de le relier aux autres murs est de l'agrandir avec trois carrés à sa gauche.",
      ...
      "Si ton île est déjà complète, la case BLANCe adjacente doit être noire."
    ]
